...
import { Home, List, Folder, Settings, ChevronLeft, ChevronRight, User, Menu, ChevronDown, ChevronUp } from 'lucide-react';
import CategoryTree from './categoryTree';
import { useNavigate } from 'react-router-dom';

const Sidebar = ({ categories, selectedCategoryId, setSelectedCategoryId, sidebarOpen, setSidebarOpen, onOpenCategoryModal }) => {
  ...
  const menuItems = [
    ...
    { label: 'Parts', icon: <List size={20} />, onClick: () => navigate('/parts') },
